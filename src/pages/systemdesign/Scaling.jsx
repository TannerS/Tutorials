...
export default function Scaling() {
  return (
    ...
    >
      ...
      <InfoBox type="info" title="Health Checks">
...
server {
    ...
    location /static/ {
      ...
      <InfoBox type="tip" title="Right-Size Before Auto-Scaling">
      ...
      <InfoBox type="warning" title="CDN Cache Invalidation Gotcha">
      ...
      <InfoBox type="info" title="Replica Promotion">
...
for i in range(200):
    if limiter.allow_request():
      ...
      <InfoBox type="tip" title="Distributed Rate Limiting">
