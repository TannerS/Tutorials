...
export default function Interview() {
  return (
    ...
    >
      ...
      <InfoBox type="warning" title="Most Common Mistake">
        <p>
...
# Peak outgoing (3x):           ~6 MB/s`} />
      ...
      <InfoBox type="tip" title="Round Aggressively">
        <p>
      ...
      <InfoBox type="info" title="What Interviewers Actually Evaluate">
        <p>
      ...
      <InfoBox type="tip" title="Honesty Builds Trust">
        <p>
