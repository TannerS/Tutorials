...
export default function Databases() {
  return (
    ...
    >
      ...
      <InfoBox variant="tip" title="Choosing the Right Database">
      ...
      <InfoBox variant="warning" title="ACID in Financial Systems">
...
ORDER BY created_at DESC;`}
      ...
      <InfoBox variant="warning" title="The Danger of Over-Indexing">
    ...
    S2 --> R2[Replica 2]`}
      ...
      <InfoBox variant="tip" title="Preventing Hotspots">
    ...
    Primary -->|WAL| WAL[Write-Ahead Log]`}
      ...
      <InfoBox variant="info" title="Denormalization in Interviews">
...
REFRESH MATERIALIZED VIEW CONCURRENTLY daily_sales_summary;`}
      ...
      <InfoBox variant="tip" title="Database Selection in System Design Interviews">
