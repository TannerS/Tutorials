...
type LogFn = (msg: string, flush?: boolean) => void;
...
function colorFor(msg: string): string {
...
/* ────────────────────────────────────────────
   ChildDemo
   ──────────────────────────────────────────── */
function ChildDemo({ label, value }: { label: string; value: number }) {
...
interface ParentDemoProps {
  ...
  childProp: number;
  secondChildMounted: boolean;
  count: number;
  log: LogFn;
}

function ParentDemo({ childMounted, childProp, secondChildMounted, count, log }: ParentDemoProps) {
...
/* ────────────────────────────────────────────
   LogPanel
   ──────────────────────────────────────────── */
const LogPanel = memo(function LogPanel({ entries }: { entries: LogEntry[] }) {
...
export default function LifecycleSimulator() {
  ...
  const pushLog = useCallback<LogFn>((msg, flush = false) => {
